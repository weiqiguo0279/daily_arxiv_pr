...
- [ThinkDrive: Chain-of-Thought Guided Progressive Reinforcement Learning Fine-Tuning for Autonomous Driving](https://arxiv.org/abs/2601.04714)
  ...
  - Summary：
    ...
    - Evaluation shows ThinkDrive outperforms strong RL baselines on key metrics and a 2B-parameter model trained with this method surpasses the larger GPT-4o by 3.28% on the exam metric.
...
- [UniDrive-WM: Unified Understanding, Planning and Generation World Model For Autonomous Driving](https://arxiv.org/abs/2601.04453)
  ...
  - Summary：
    ...
    - The model's trajectory planner predicts a future trajectory to condition a VLM-based image generator, producing future frames that provide supervisory signals to iteratively refine trajectory generation.
