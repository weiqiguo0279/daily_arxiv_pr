...
- [ThinkDrive: Chain-of-Thought Guided Progressive Reinforcement Learning Fine-Tuning for Autonomous Driving](https://arxiv.org/abs/2601.04714)
  ...
  - Summary：
    ...
    - The method employs a two-stage training strategy: supervised fine-tuning with CoT explanations, followed by progressive RL with a difficulty-aware adaptive policy optimizer that adjusts learning intensity based on sample complexity.
