...
- [UniDrive-WM: Unified Understanding, Planning and Generation World Model For Autonomous Driving](https://arxiv.org/abs/2601.04453)
  ...
  - Summary：
    ...
    - Experiments on the Bench2Drive benchmark show improvements of 5.9% in L2 trajectory error and 9.2% in collision rate over the previous best method, demonstrating advantages of tightly integrating VLM-driven reasoning, planning, and generative world modeling.
