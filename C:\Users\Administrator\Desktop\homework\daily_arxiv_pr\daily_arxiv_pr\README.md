...
- [Modular Autonomy with Conversational Interaction: An LLM-driven Framework for Decision Making in Autonomous Driving](https://arxiv.org/abs/2601.05806)
  ...
  - Summary：
    ...
    - Introduces a methodology with three key components: a taxonomization of interaction categories, an application-centric Domain Specific Language (DSL) for command translation, and a safety-preserving validation layer.
...
- [Modular Autonomy with Conversational Interaction: An LLM-driven Framework for Decision Making in Autonomous Driving](https://arxiv.org/abs/2601.05806)
  ...
  - Task: Planning
  - Summary：
    - Proposes an LLM-driven framework that integrates a natural language interaction layer with the Autoware modular autonomous driving software stack.
