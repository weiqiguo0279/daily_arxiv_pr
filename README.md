...
- [UniDrive-WM: Unified Understanding, Planning and Generation World Model For Autonomous Driving](https://arxiv.org/abs/2601.04453)
  ...
  - Summary：
    - UniDrive-WM, a unified VLM-based world model that jointly performs driving-scene understanding, trajectory planning, and trajectory-conditioned future image generation within a single architecture.
    - The model uses predicted trajectories to condition a VLM-based image generator, creating supervisory signals that enhance scene understanding and iteratively refine trajectory generation.
...
- [FROST-Drive: Scalable and Efficient End-to-End Driving with a Frozen Vision Encoder](https://arxiv.org/abs/2601.03460)
  ...
  - Publisher: (Inferred from authors' affiliations: University of California, San Diego)
  - Publish Date: 2026.01.06
  - Task: End-to-End
  - Datasets: [Waymo Open E2E Dataset](https://waymo.com/open/)
  - Summary：
    - Proposes FROST-Drive, a novel End-to-End (E2E) autonomous driving architecture that keeps a pretrained Vision-Language Model (VLM) encoder frozen to preserve its generalization capabilities.
    - Introduces a transformer-based adapter for multimodal fusion and a GRU-based decoder for waypoint generation, with a custom loss function optimized for Rater Feedback Score (RFS).
